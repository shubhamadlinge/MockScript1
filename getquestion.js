...
// console.log(await coll.find({}).toArray());
    ...
    for(let i=0;i<8-per_skill*skill_arr.length;i++) {
          que_fre[i]++;
    }
...
console .log(questions[0].questions[n])
break;
        }}
      }
      // final_list.push();
    ...
    // let temp=['What are the type of Constructor ?','Tell me types of inheritance in java.','What is firewall in Computer Network ?','What is EC2 service in AWS ?','When are comments used in HTML','What is a database system?'];


    return [ 'What are the types of the constructors in C++ ?',
